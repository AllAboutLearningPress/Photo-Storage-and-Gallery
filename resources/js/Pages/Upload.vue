            ...
            <div class="wrapper">
                <div class="toolbar">
                    <div class="toolbar__main">
                        <a
                            title="Go back"
                            href="#"
                            class="js-go-back btn-subtle btn"
                        >
                            <svg
                        ...
                        <a
                            title="Go home"
                            href="#"
                            class="js-go-home btn-subtle btn"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                    ...
                    <div class="toolbar__aside">
                        <div class="toolbar__specific-actions"></div>
                ...
                <div class="content">
                    <h2 class="fw-light mb-5">
                        Uploading 3 pictures, please take a moment to add
                                ...
                                <div class="file">
                                    ...
                                    <div class="file__details">
                                        ...
                                        <div class="file__header">
                                            <div
                                                class="js-editable editable file__title"
                                            >
                                                <h3
                                                    class="editable__content fs-4 fw-light"
                                                >
                                                    <span
                                                        class="js-editable__val"
                                                    >
...
My title</textarea
            ...
            <div class="js-drop-target drop-target">
                <div class="drop-target__message">Drop anywhere</div>
            </div>
                    ...
                    >
                        <div class="d-flex">
                            <div class="toast-body">
                                Some of the file types you dropped aren't
                                allowed
                            </div>
                            <button
                                type="button"
