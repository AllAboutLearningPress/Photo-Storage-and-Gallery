    ...
    <div class="wrapper">
        <div class="toolbar">
            <div class="toolbar__main">
                <a title="Go back" href="#" class="js-go-back btn-subtle btn">
                    <svg
                ...
                <a title="Go home" href="#" class="js-go-home btn-subtle btn">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
        ...
        <div class="content">
            <h2 class="fw-light mb-5">
                Uploading 3 pictures, please take a moment to add details, or
                keep using a site
                                ...
                                <div class="js-tags tags">
                                    ...
                                    <div class="js-tags__list tags__list">
                                        ...
                                        <a
                                            ...
                                            href="#"
                                        >
                                            Some tag ometagomet agomet agometa
                                            etag
                                            <object type="no/suchtype">
                                                <button
                                                    title="Delete tag"
